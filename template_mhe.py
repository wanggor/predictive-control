...
def template_mhe(model, config):
    ...
    def p_fun_mhe(t_now):
        p_template_mhe['Theta_2'] = config["i2"] *1e-4
        p_template_mhe['Theta_3'] = config["i3"] *1e-4
    ...
    mhe.bounds['lower','_u','phi_m_set'] = config["constrain_motor_lower"]*np.pi
    mhe.bounds['upper','_u','phi_m_set'] = config["constrain_motor_upper"]*np.pi
